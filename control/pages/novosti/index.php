  ...
  <main class="main control">
    <section class="section control__section">
      <div class="container control__container">
        <div class="control__head choice__form">
          ...
          <a class="control__btn btn btn_green" href="/control/pages/novosti/create.php">
            Создать новость
          </a>
        </div>
      </div>
    ...
    <section class="section control__section content">
      ...
      <div class="container control__container control__content">
        ...
        <?
            $resultNews = mysqli_query($db, "SELECT * FROM news ORDER BY date ASC");
            $news = mysqli_fetch_array($resultNews);

            if (mysqli_num_rows($resultNews) > 0) {
              do {

                $class = $news['status'] === '1' ? '_active' : '';
                ...
                <div class='news__btn-block card__btn-block' data-id={$news['id']}>
                ...
                <button class='card__btn card__btn_edit' data-id={$news['id']}>
                ...
                <button class='card__btn card__btn_delete' data-id={$news['id']}>
                  <svg width='24' height='25' viewBox='0 0 24 25' fill='none' xmlns='http://www.w3.org/2000/svg'>
