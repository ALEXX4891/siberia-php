    ...
    <section class="section promo-page__section">
      <div class="container promo-page__container">
        ...
        <div class="promo-page__btn-wrapper">
          <a class="promo-page__btn promo-page__btn_white" href="novosti.html">
            Новости
          </a>
          <a class="promo-page__btn promo-page__btn_green" href="akcii.html">
            Акции
          </a>
        </div>
        ...
        <ul class="promo-page__cards-list">
          <li class="promo-page__cards-item">
            <div class="promo-page__card-img-wrapper">
              <picture><source srcset="img/promo-img-1.webp" type="image/webp"><img src="img/promo-img-1.jpg" alt="Проект"></picture>
            </div>
          ...
          <li class="promo-page__cards-item">
            <div class="promo-page__card-img-wrapper">
              <picture><source srcset="img/promo-img-2.webp" type="image/webp"><img src="img/promo-img-2.jpg" alt="Проект"></picture>
            </div>
            <span class="promo-page__card-date">
              01 мая 2024
            </span>
