        ...
        <div class="rep-wrap" data-id="1">
          <div class="slider__left">
            ...
            <p class="slider__text">
              Стены и потолки в квартире выровнены шпаклёвкой, отсюда и название White Box.
              Мы позаботились о том, чтобы подготовить квартиру к последнему — косметическому ремонту,
              после которого остаётся только покрыть стены и расставить мебель.
              Установка унитаза, смесителей, межкомнатных дверей, розеток и выключателей.<br><br>
              Есть несомненные плюсы, связанные с предчистовой отделкой квартир или квартир «белого ящика»,
              например, экономия денег и усилий, поскольку самая сложная и грязная работа уже сделана.
            </p>
          </div>
