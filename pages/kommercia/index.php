        ...
        <div class="choice__form" action="#" method="post" enctype="multipart/form-data">
          ...
          <div class="choice__reset-wrap">
            <button class="choice__btn-reset" href="#popup-form">
              <a class="choice__btn-text" href="kvartiry.html">
                Сбросить фильтры
              </a>
              ...
              <ul class="cards__list">
                <li class="cards__item">
                  <div class="cards__item-img">
                    <picture><source srcset="img/com-prev-1.webp" type="image/webp"><img src="img/com-prev-1.jpg" alt="превью"></picture>
                  </div>
          ...
          <li class="commercial__item swiper-slide">
            <a class="commercial__item-link" href="commercial-item.html">
              ...
              <div class="commercial__item-img">
                <picture><source srcset="img/com-img-1.webp" type="image/webp"><img src="img/com-img-1.png" alt="квартира"></picture>
              </div>
            </a>
