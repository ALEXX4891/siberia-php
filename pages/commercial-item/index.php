...
<body class="commercial-item-page">
  ...
  <main class="main commercial-item-page__main">
    <section class="section commercial-item-page__section about">
      <div class="container about__container">
        <div class="about__left">
          ...
          <div class="about__btn-wrap">
            <button class="about__btn about__btn_active about__btn_plan">
              Планировка
            </button>
            <button class="about__btn about__btn_floor">
              На этаже
            </button>
          </div>
        </div>
        ...
        <div class="about__right choice__form" choice-form>
          ...
          <p class="about__right-title title title_25">
            Помещение №4, 269,65м2
          </p>

          <div class="about__right-wrapper">
            ...
            <div class="about__right-rent-wrap">
              <p class="about__right-rent-title">
                Аренда
              </p>
              <p class="about__right-rent-text">
                110 560 ₽/мес
              </p>
            </div>
          </div>
          ...
          <div class="about__right-info">
            <div class="about__right-info-left">
              ...
              <p class="about__right-info-text about__right-info-text-floor">
                1
              </p>
            </div>
          ...
          <div class="about__right-location-wrap">
            <p class="about__right-location-title">
              Локация
            </p>
            <p class="about__right-location-text">
              Тюменская область, Тюменский район, р.п. Винзили, ул. Сосновая 3к2
            </p>
          </div>
            ...
            <ul class="about__right-radio-wrap checkbox-list">
              ...
              <li class="checkbox">
                <label class="checkbox__label">
                  ...
                  <p class="checkbox__desc">
                    Помещение для бизнеса в аренду
                  </p>
                </label>
              </li>
    ...
    <section class="section section_bot bot" id="office">
      <div class="container bot__container">
        ...
        <div class="bot__address address">
          ...
          <div class="address__wrapper">
            ...
            <div class="address__item address__item_mail">
              ...
              < class="address__item-text" href="mailto:<?= $office['email']; ?>">
                <?= $office['email']; ?>
                </a>
            </div>
        ...
        <div class="bot__map map-yandex2" id="map">
        </div>
        <!-- </div> -->
