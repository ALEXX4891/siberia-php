      ...
      <div class="container about__container">
        <div class="about__top">
          ...
          <div class="about__btn-wrapper">
            <a class="about__btn about__btn_green" href="o-companii.html">
              О компании
            </a>
            <a class="about__btn about__btn_white" href="sotrudnichestvo.html">
              Сотрудничество
            </a>
          </div>
        </div>
        ...
        <div class="about__content">
          <div class="about__content-top">
            <h1 class="about__content-title">
              Строим комфортную среду для жизни
            </h1>

            <p class="about__content-text">
              Сибирь — динамично развивающаяся российская строительная компания, специализирующаяся на реализации
              жилых домов различной этажности: от разработки концепции до эксплуатации
            </p>
          </div>
          ...
          <div class="slider__right slider_swiper">
            <ul class="slider__list swiper-wrapper">
              <li class="slider__item swiper-slide">
                <picture><source srcset="img/slide-1.webp" type="image/webp"><img src="img/slide-1.jpg" alt="фасад дома"></picture>
              </li>
              <li class="slider__item swiper-slide">
                <picture><source srcset="img/slide-2.webp" type="image/webp"><img src="img/slide-2.jpg" alt="фасад дома"></picture>
              </li>
              <li class="slider__item swiper-slide">
                <picture><source srcset="img/slide-3.webp" type="image/webp"><img src="img/slide-3.jpg" alt="фасад дома"></picture>
              </li>
              <li class="slider__item swiper-slide">
                <picture><source srcset="img/slide-4.webp" type="image/webp"><img src="img/slide-4.jpg" alt="фасад дома"></picture>
              </li>
              <li class="slider__item swiper-slide">
                <picture><source srcset="img/slide-5.webp" type="image/webp"><img src="img/slide-5.jpg" alt="фасад дома"></picture>
              </li>
              <li class="slider__item swiper-slide">
                <picture><source srcset="img/slide-6.webp" type="image/webp"><img src="img/slide-6.jpg" alt="фасад дома"></picture>
              </li>
              <li class="slider__item swiper-slide">
                <picture><source srcset="img/slide-7.webp" type="image/webp"><img src="img/slide-7.jpg" alt="фасад дома"></picture>
              </li>
            </ul>
    ...
    <section class="section section__standarts standarts">
      <div class="container standarts__container">
        ...
        <div class="standarts__img">
          <picture><source srcset="img/standarts-img.webp" type="image/webp"><img src="img/standarts-img.jpg" alt="стендарты"></picture>
        </div>
      </div>
    </section>
      ...
      <div class="container history__container">
        ...
        <ul class="history__list">
          ...
          <li class="history__item">
            ...
            <p class="history__item-text">
              Компания начинает свою деятельность в Тюмени и приобретает первый земельный участок
            </p>
          </li>
          ...
          <li class="history__item">
            ...
            <p class="history__item-text">
              Первый собственный проект малой этажности. Комплекс сдан в мае 2025 
            </p>
          </li>
        </ul>
      </div>
        ...
        <ul class="project-page__list">
          <li class="project-page__item">
            <a class="project-page__link" href="project-item.html">
              <div class="project-page__card-img">
                <picture><source srcset="img/building-1.webp" type="image/webp"><img src="img/building-1.jpg" alt=""></picture>
          ...
          <li class="project-page__item">
            <a class="project-page__link" href="project-item.html">
              ...
              <div class="project-page__card-img">
                <picture><source srcset="img/building-2.webp" type="image/webp"><img src="img/building-2.jpg" alt=""></picture>
                <div class="project-page__card-info">
