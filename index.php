  ...
  <main class="main glavnaya__main glavnaya__main_top">
    <section class="section section_banner banner">
      <div class="container banner__container">
        ...
        <a class="banner__btn btn btn_dark btn_reset" href="kvartiry.html" scrollspy="plans">
          Смотреть планировки
        </a>
        <!-- </div> -->
          ...
          <li class="building__cards-item swiper-slide">
            ...
            <div class="building__card-content">
              ...
              <div class="building__card-footer">
                ...
                <a class="building__card-link" href="kvartiry.html">
                  128 квартир
                </a>
              </div>
            </div>
      ...
      <div class="container choice__container">
        ...
        <div class="choice__form" action="#" method="post" enctype="multipart/form-data">
          ...
          <div class="choice__btn-wrap">
            ...
            <a class="choice__btn-request btn btn_dark" href="kvartiry.html">
              Смотреть квартиры
            </a>
    ...
    <section class="section section_regions regions">
      <div class="container regions__container regions_swiper">
        ...
        <div class="regions-banner">
          ...
          <a class="regions-banner__button" href="kommercia.html">
            Выбрать помещение
          </a>
        </div>
    ...
    <section class="section section_apartments apartments">
      <div class="container apartments__container apartments_swiper">
        <div class="apartments__top-wrap">
          ...
          <a class="apartments__button apartments__button_desc btn btn_dark" href="kvartiry.html">
          ...
          <li class="apartments__item swiper-slide">
            <a class="apartments__item-link" href="apartments-item.html">
              ...
              <div class="apartments__item-img">
                <picture><source srcset="img/apartment-1.webp" type="image/webp"><img src="img/apartment-1.png" alt="квартира"></picture>
              </div>

              <p class="apartments__item-desc">
                2-комнатная 61,88м<sup>2</sup>
              </p>
        ...
        <a class="apartments__button apartments__button_mob btn btn_green" href="kvartiry.html">
          Посмотреть все квартиры
        </a>
          ...
          <ul class="promo__list swiper-wrapper">
            <li class="promo__item swiper-slide">
              <div class="promo__item-img">
                <picture><source srcset="img/promo_1.webp" type="image/webp"><img src="img/promo_1.jpg" alt="promo_1"></picture>
              </div>
        ...
        <ul class="news__list swiper-wrapper">
          <li class="news-slider__cards-item swiper-slide">
            <div class="news-slider__card-img-wrapper">
              <picture><source srcset="img/news-img-1.webp" type="image/webp"><img src="img/news-img-1.jpg" alt="Проект"></picture>
            </div>
          ...
          <li class="news-slider__cards-item swiper-slide">
            <div class="news-slider__card-img-wrapper">
              <picture><source srcset="img/news-img-4.webp" type="image/webp"><img src="img/news-img-4.jpg" alt="Проект"></picture>
            </div>
            <p class="news-slider__card-date">
              01 мая 2024
            </p>
          ...
          <li class="news-slider__cards-item swiper-slide">
            <div class="news-slider__card-img-wrapper">
              <picture><source srcset="img/news-img-2.webp" type="image/webp"><img src="img/news-img-2.jpg" alt="Проект"></picture>
            </div>
            <p class="news-slider__card-date">
              01 мая 2024
            </p>
          ...
          <li class="news-slider__cards-item swiper-slide">
            <div class="news-slider__card-img-wrapper">
              <picture><source srcset="img/news-img-3.webp" type="image/webp"><img src="img/news-img-3.jpg" alt="Проект"></picture>
            </div>
            <p class="news-slider__card-date">
              01 мая 2024
            </p>
