...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 23 2024 г., 10:24
...
(1, 'Основные контакты', '8 (3452) 38-70-90', 'zhk.sosnovyy@mail.ru', 'Тюмень, ул. Мельникайте, д. 116 корпус 1 офис 67, МК «АРСИБ Тауэр»\r\nЕжедневно: 8:00-20:00', '<!--LiveInternet counter--><script>\r\nnew Image().src = \"https://counter.yadro.ru/hit?r\"+\r\nescape(document.referrer)+((typeof(screen)==\"undefined\")?\"\":\r\n\";s\"+screen.width+\"*\"+screen.height+\"*\"+(screen.colorDepth?\r\nscreen.colorDepth:screen.pixelDepth))+\";u\"+escape(document.URL)+\r\n\";h\"+escape(document.title.substring(0,150))+\r\n\";\"+Math.random();</script><!--/LiveInternet-->\r\n', 1, 1);
...
CREATE TABLE `events` (
  ...
  `photo-alt` varchar(256) NOT NULL,
...
INSERT INTO `events` (`id`, `title`, `date`, `time`, `photo`, `photo-alt`, `description`, `status`, `publish`) VALUES
(1, 'акция1 акция1 акция1ertewerwer', '2024-09-20', '2024-08-26 19:40:32', 'event-img-1.jpg', 'altaltalt', 'акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1акция1 акция1 акция1', 1, 1),
(2, 'акция2 акция233', '2024-08-05', '2024-09-20 17:40:32', '898-200924-134403.jpg', 'altaltalt', '<p>акция2 акция2акция2 акция2акция2 акция2акция2 акция2акция2 акция2акция2 акция2акция2 акция2акция2 акция2акция2 акция2акция2 акция2акция2 акция2акция2 акция2акция2 ак<strong>ция2акция2</strong> акция2акция2 акция2акция2 акция2акция2 акция2акция2 акция2акция2 акция2акция2 акция2акция2 акция2акция2 акция2акция2 акция2акция2 акция2</p>', 1, 1),
(3, 'акция3 акция3 акция3', '2024-08-01', '2025-10-23 00:00:00', '965-230924-113236.jpg', 'altaltalt', 'акция3 акция3 акция3акция3 акция3 акция3акция3 акция3 акция3акция3 акция3 акция3акция3 акция3 акция3акция3 акция3 акция3акция3 акция3 акция3акция3 акция3 акция3акция3 акция3 акция3акция3 акция3 акция3акция3 акция3 акция3акция3 акция3 акция3акция3 акция3 акция3акция3 акция3 акция3акция3 акция3 акция3акция3 акция3 акция3', 0, 1),
(5, 'hgjghjgh', '2024-09-20', '2025-10-23 00:00:00', '264-200924-140002.jpg', 'altaltalt', 'ghjjjjjjjjjjjjjjjjjj jghj ghjgh ghjgh jhg ghjghjghj ghjg h', 1, NULL);
...
CREATE TABLE `news` (
  ...
  `meta-desc` varchar(3000) NOT NULL,
...
INSERT INTO `news` (`id`, `title`, `date`, `description`, `meta-desc`, `photo`, `image-1`, `image-2`, `image-3`, `image-4`, `image-5`, `image-6`, `image-7`, `image-8`, `image-9`, `image-10`, `status`, `publish`) VALUES
...
(12, 'fdsfd5', '2024-09-29', '', '', '440-230924-142926.jpg', '850-230924-142926.jpg', '', '', '', '', '', '', '', '', '', 1, NULL),
(13, 'fsdfsdfsd', '2024-09-20', 'fsdfsdfsdfsdf', '', '501-200924-124141.jpg', '', '', '', '', '', '', '', '', '', '', 0, NULL),
(14, 'sdfdfsd544444444444444', '2024-10-06', 'sdfsfsdfsdf4444444444444', 'Для инвесторов и жителей управляющая компания организует поиск клиентов, бронирование и сдачу квартир, подготовку отчётных документов, уборку квартир, питание и коворкинг', '732-200924-134853.jpg', '441-200924-134853.jpg', '', '', '', '', '', '', '', '', '', 1, NULL),
(15, 'dfdgdf444444444444', '2024-09-23', '', '', '382-230924-144830.jpg', '631-230924-144830.jpg', '', '', '', '', '', '', '', '', '', 1, NULL);
...
(1, 'Офис продаж Тюмень', 'Ежедневно с 10:00-17:00', 'Тюмень, ул. Малыгина, д. 52', '7(834) 526 11 15', 'sosnovy@siberiadev.ru', 1, NULL),
